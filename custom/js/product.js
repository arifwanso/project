...
$(document).ready(function() {
	...
	manageProductAVBTable = $('#manageProductAVBTable').DataTable({
		'ajax':'php_action/fetchProductAVB.php',
		'order':[]
	});
	manageProductWNTable = $('#manageProductWNTable').DataTable({
		'ajax':'php_action/fetchProductWN.php',
		'order':[]
	});
	manageProductNAVBTable = $('#manageProductNAVBTable').DataTable({
		'ajax':'php_action/fetchProductNAVB.php',
		'order':[]
	});
